...
const ConDetalle = ({ steps, currentStep, onChange, onNextStep, onBack, data }) => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await fetch('https://cert-sacr-bice.indexa.cl/api/integracioncreditos/crediauto/inyectar', {
                method: 'GET',
                headers: {
                    'Content-type': 'application/json;charset=UTF-8',
                    'Authorization': '/BiDDlxZFEm4Jqr8V/5ru8sB7J+wSkHi6mwjoj9F/KthTA37xkhK+Q=='
                },
    ...
    return (
        <div style={{ width: '100%' }}>
            ...
            <form className='form-container'>
                <div class="formControl-root">
                    ...
                    <div className='outlinedInput-root textField-root inputBase-root'>
                        <select onChange={handleInputChange} name="entidad" className='form-input-column' style={{ width: 'calc(100% - 16px)' }}>
                ...
                <div className='cuotas-container'>
                    ...
                    <div class="formControl-root">
                        <label className='inputLabel-root formLabel-root inputLabel-formControl inputLabel-outlined'>Cuotas totales*</label>
                        <div className='outlinedInput-root textField-root inputBase-root'>
                            <input type="text" className='form-input-column' ></input>
                        </div>
                    </div>
                ...
                <div className='vehiculo-container'>
                    <div class="formControl-root">
                        <label className='inputLabel-root formLabel-root inputLabel-formControl inputLabel-outlined'>Marca*</label>
                        <div className='outlinedInput-root textField-root inputBase-root'>
                            <input type="text" id="marca" name="marca" className='form-input-column' ></input>
                        </div>
                    </div>
                    <div class="formControl-root">
                        <label className='inputLabel-root formLabel-root inputLabel-formControl inputLabel-outlined'>Modelo*</label>
                        <div className='outlinedInput-root textField-root inputBase-root'>
                            <input type="text" id="modelo" name="modelo" className='form-input-column' ></input>
                        </div>
                    </div>
                </div>
                <div className='vehiculo-year-container'>
                    <div class="formControl-root">
                        <label className='inputLabel-root formLabel-root inputLabel-formControl inputLabel-outlined'>Año del vehículo*</label>
                        <div className='outlinedInput-root textField-root inputBase-root'>
                            <select
                                name="anno"
                                className='form-input-column'
                            ...
                            >
                                <option value="" disabled hidden>Seleccionar año</option>
            ...
            <div className='navButtonContainer' >
                <input type='button' className="atrasButton" value="Atrás" onClick={handlePreviousStep} />
